	...
	while(True):
		...
		if TON_01.salida:
			...
			if contador == 1 and SECUENCIA_COBRO == 0:
				...
				if len(data) > 4:
					...
					#	ESTADO_ACEPTACION = 2
						...
						ESTADO_ACEPTACION = 3
					elif data[2] == 21 and ESTADO_ACEPTACION == 3: # Esperando VEND VALID  16/21
						ESTADO_ACEPTACION = 4
						print('VEND VALID')
			...
			if contador == 2 and SECUENCIA_COBRO == 1:
				...
				elif data[2] == 35 and ESTADO_ACEPTACION == 3: # Esperando PAY VALID  21
					ESTADO_ACEPTACION = 4
					r = comunicacionJcm(ACK_JCM2)
					print('ACK',r)
...
def ackJCM():
	...
	time.sleep(.01)
	return trama
def comunicacionJcm2(comandoJcm):
	limpiar()
	ser.write(ACK_JCM2)
	time.sleep(.1)
	r = ser.read(20) #Verificar en el simulador se ven 19
