...
def leerArchivo():
	...
	A=0
	#mixer.init()
	#mixer.music.load('/home/cajero/Downloads/beep-08b.wav')
	while(kill == 0):
		#if(imprime==1):
		if(imprime==5):
			#imp()
		...
		while(killer == 0 and kill == 0):
			...
			if(folio != ''):
				...
				if(str("M") in str(folio)):
					#os.system('sudo python3 /home/cajero/scanner/buz.py')
					#mixer.music.play()
					#time.sleep(1)
					pass
					print(folio)
...
def solicitarCambio(cambioSolicitado):
				...
				while(dispensandoCambio):
					...
					if estatus:
						if estatus[1]:
							...
							print("*Entrgando Cambio*",cambioRestante,"Restante")
						else:
							dispensandoCambio = 0
				if estatus:
					if estatus[0]:
						...
						if monedasFaltantes:
							...
							print("Cambio incompleto , faltan ",monedasFaltantes," monedas",MONEDAS)
							...
							print("monedas enrtegadas de ",moneda,": ",monedasDispensadas)
							print("monedas faltantes: ",monedasFaltantes," monedas",MONEDAS)
	...
	estatus = statusHopper(HOPPER_MONEDAS_HABILITADAS[moneda])
	print("ultima moneda: ",moneda,cambioSolicitado,estatus,estatus[1])
	if estatus:
		if estatus[1]:
			cambioRestante = (estatus[1]*moneda)+cambioSolicitado
			print("*Entrgando Cambio*",cambioRestante,"Restante")
