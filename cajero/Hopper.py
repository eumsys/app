...
class Hopper (Variable):
    ...
    TIEMPO_DE_RETARDO_EN_LECTURA = 0.1
    ...
    def __init__(self, tag, nombre, descripcion, **kwargs):
        ...
        print ("Se ha creado el dispositivo con moneda ", self.variables[2].obtenerValor())
...
def main ():
    ...
    hopper1 = Hopper("Hopper 1", "HOP-100", "para monedas de 5 pesos", direccion = 3, valorDeMoneda = 5)
