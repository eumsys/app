...
PATH_ARCHIVO_CONFIGURACION_TERMINAL_SERIAL="/home/ubuntu/numeroSerial.txt"
...
def interface():
	class Ventana(QDialog):
		...
		def __init__(self):
			...
			gui = uic.loadUi("/home/ubuntu/Documentos/eum/app/cajeroF/rb.ui", self)
	...
	################MODS########
		...
		def scan(self):
			...
			if(codigo == 'M' or codigo == 'L'):
				...
				try:
					...
					leerArch = open("/home/ubuntu/Documentos/ticket.txt", "w")
		...
		def setConfig(self):
			...
			infile = open("/home/ubuntu/Documentos/eum/app/cajeroF/cajero/archivos_config/datos.txt", 'w')
			c=infile.write(dat)
		...
		def panelConfig(self):
			...
			infile = open('/home/ubuntu/Documentos/eum/app/cajeroF/cajero/archivos_config/datos.txt','r')
			...
			infile = open('/home/ubuntu/Documentos/eum/app/cajeroF/cajero/archivos_config/red.txt','r')
			datos= infile.readline()
			arr=datos.split(',')
			host=arr[0]
			ip=arr[1]
		...
		def cambiaIp(self):
			...
			self.sustituye("/home/ubuntu/Documentos/eum/app/cajeroF/cajero/cliente.py","192.168","host = '"+host+"'")
			...
			print(plaza,localidad)
			dat=host+","+ip
			infile = open("/home/ubuntu/Documentos/eum/app/cajeroF/cajero/archivos_config/red.txt", 'w')
			c=infile.write(dat)
		...
		def activaCamara(self):
			...
			try:
				...
				pass
			#p=subprocess.Popen(['/home/ubuntu/scanner/dsreader -l 1 -s 20 > /home/ubuntu/Documentos/ticket.txt'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, close_fds=True)
			
			#so=os.popen('~/bin/dsreader -l 1 -s 20 > /home/ubuntu/Documentos/ticket.txt')
			
			
		def mostrarNoSerie(self):
			global accesoAcaja,NoCajero,mensajeAyuda
			os.system("sudo grep Serial /proc/cpuinfo >> /home/ubuntu/Escritorio/numeroSerial.txt")
			configuracion=[]
		...
		def imprimeReporteEventosPDF(self):
			...
			leerArch = open("/home/ubuntu/Documentos/fechaEventos.txt", "a+")
			leerArch.write(fechaFinal)
			leerArch.close()
			os.system("sudo python3 /home/ubuntu/Documentos/eum/app/cajeroF/cajero/reporteEventosPDF.py")
		...
		def imprimeReporteEventos(self):
			...
			leerArch.write(fechaFinal)
			leerArch.close()
			os.system("sudo python3 /home/ubuntu/Documentos/cajero/reporteEventos.py")
		...
		def imprimeReporteTarifas(self):
			...
			fecha2=dia2+"/"+mes2+"/"+anio2+" 23:59:59"
			fechaFinal=fecha1+","+fecha2
			leerArch = open("/home/ubuntu/Documentos/fechaTarifas.txt", "a+")
			leerArch.write(fechaFinal)
			leerArch.close()
			os.system("sudo python3 /home/ubuntu/Documentos/cajero/reporteTarifas.py")
		...
		def imprimeReporte(self):
			...
			leerArch = open("/home/ubuntu/Documentos/reporteCorteCaja.txt", "a+")
			leerArch.write(datos)
			leerArch.close()
			os.system("sudo python3 /home/ubuntu/Documentos/cajero/imprimeCorte.py")
		...
		def llenaCamposPlaza(self):
			...
			infile = open("/home/ubuntu/Documentos/plaza.txt", 'r')
			c=infile.readline()
			arr=c.split(',', 1 )
			infile.close()
			nom=str(arr[0])
		...
		def cambiaNombre(self):
			...
			fecha=hora.mostrarFechayHora()
			outfile = open("/home/ubuntu/Documentos/plaza.txt", 'w')
			nn=self.lnom.text()
			ln=self.llol.text()
			...
			outfile = open("/home/ubuntu/Documentos/NoCajero.txt", 'w')
		...
		def tarifaConfirmada(self):
			...
			if(self.prioridad!=0):
				...
				archivo = open("/home/ubuntu/Documentos/NoCajero.txt", "r")
...
def leerArchivo():
	...
	A=0
	#mixer.init()
	#mixer.music.load('/home/ubuntu/Downloads/beep-08b.wav')
	while(kill == 0):
		#if(imprime==1):
		if(imprime==5):
			#imp()
			...
			leerArch = open("/home/ubuntu/Documentos/pago.txt", "a+")
			leerArch.write(fec)
			leerArch.close()
			os.system("sudo python3 /home/ubuntu/Documentos/cajero/archimp.py")
		...
		while(killer == 0 and kill == 0):
			leerArch = open("/home/ubuntu/Documentos/ticket.txt", "r")
			...
			if(folio != ''):
				...
				if(str("M") in str(folio)):
					#os.system('sudo python3 /home/ubuntu/scanner/buz.py')
					#mixer.music.play()
					#time.sleep(1)
					pass
					print(folio)
					if(folio == 'boleto perdido'):
						...
						if(str("Admin") in str(fo)):
							...
							if(cajeroSuspendido==1):
								...
								#return 2
								resultado =  conexion.buscarTicket(mensaje)
								if(not conexion_activa):
									leerArch = open("/home/ubuntu/Documentos/eum/sys/descuento.txt", "r")
									...
									if(int(sello) == 1):
										...
										descuento=1
									leerArch.close()
									leerArch = open("/home/ubuntu/Documentos/eum/sys/descuento.txt", "w")
									leerArch.write('0')
									leerArch.close()
...
def Init(ser):
	...
	infile = open("/home/ubuntu/Documentos/NoCajero.txt", 'r')
...
def count(ser):
	...
	if(registraPago==1):
		...
		if(not conexion_activa):
			...
			try:
				print("Sin conexion")
				print("Encolando nuevo pago: ",cola.incluir(mensajeTotal))
				print("Pagos pendientes: ",cola.inspeccionar())
				print("Cantidad de pagos: ",cola.tamano())
				resultado=-1
			except:
			...
			try:
				resultado=conexion.registrarPago(mensajeTotal)
				if(resultado==-1):
					Sinpago=Sinpago+1
				...
				while(not cola.estaVacia()):
					print("Pagos pendientes: ",cola.inspeccionar())
					print("Pagos restantes: ",cola.tamano())
					resultado=conexion.registrarPago(cola.extraer())
					if(resultado==-1):
						#break
						Sinpago=Sinpago+1
						print("No se pudo registrar el pago")
			except:
				print("Error al registrar pagos pendientes")
	...
	while(1):
		...
		if(cam==camInicial):
			...
			try:
				...
				lee = os.system("zbarcam --raw --prescale=280x150   "+cam+" > /home/ubuntu/Documentos/ticket.txt")
				#lee = os.system("zbarcam --raw  --prescale=10x10 /dev/video0 > /home/ubuntu/Documentos/eum/app/caseta/ticket.txt")
				#lee = os.system("/home/ubuntu/Documentos/eum/app/caseta/dsreader -l 27 -b 14 -r 30 -s 100 -u 50  > /home/ubuntu/Documentos/eum/app/caseta/ticket.txt")
				#lee = os.system("cd /home/ubuntu/scanner/dsreader")
				#lee = os.system("./dsreader -l 27 -b 14 -r 30 -s 100 -u 50  > /home/ubuntu/Documentos/eum/app/caseta/ticket.txt")
...
if __name__ == "__main__":
	#global ser
	os.system("echo ubuntu131313 | sudo -S chmod 777 /dev/ttyUSB*")
	time.sleep(3)
	
	ser = serial.Serial(obtenerNombreDelPuerto(dispositivo = Botones.PUERTO_ARDUINO_MICRO))  # Open named port
	#ser = Botones("/dev/ttyUSB0", 3, 3, dispositivo = Botones.PUERTO_ADAPTADOR)
